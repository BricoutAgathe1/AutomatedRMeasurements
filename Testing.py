...
test_dataset = UltrasoundDataset(test_image_dir, train_mask_dir, image_transforms)
...
model.load_state_dict(torch.load('best_combined_segmentation_model_weights.pth'))
