...
merged_folder = "../Datasets/Chris_scanners/Merged_Enhanced"  # Destination folder for all images and masks
output_dir = "../Datasets/Chris_scanners/Splits_651520"  # Output folder for dataset splits
