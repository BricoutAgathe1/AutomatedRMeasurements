...
previous_weights_path = '../Model weights/MUIA_model_weights_resnet18.pth'
...
best_weights_path = os.path.join(save_dir, 'MUIA_model_weights_resnet18.pth')
...
csv_file_path = "../training_metrics_30epochs_resnet18.csv"
