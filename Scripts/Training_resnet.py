...
model = ResNetSegmentation(backbone='resnet18', num_classes=2).to(device)  # Choose backbone as needed


# Load previous weights if resuming training for fine-tuning
previous_weights_path = '../Model weights/best_segmentation_model_weights_resnet18.pth'
...
best_weights_path = os.path.join(save_dir, 'best_segmentation_model_weights_resnet18.pth')
...
csv_file_path = "../training_metrics_100epochs_resnet18.csv"
