...
for epoch in range(num_epochs):
    ...
    if avg_val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), '../Model weights/best_segmentation_model_weights.pth')
...
for epoch in range(num_epochs):
    ...
    if avg_val_loss < best_val_loss:
        best_val_loss = avg_val_loss
        torch.save(model.state_dict(), '../Model weights/best_combined_segmentation_model_weights.pth')
        print(f"Best model saved with val loss: {best_val_loss}")
